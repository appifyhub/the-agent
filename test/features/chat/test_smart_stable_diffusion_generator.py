...
class SmartStableDiffusionGeneratorTest(unittest.TestCase):
    ...
    def test_execute_success(self):
        ...
        # noinspection PyUnresolvedReferences
        self.mock_platform_sdk.send_photo.assert_called_once_with(
    ...
    def test_execute_send_photo_failure(self):
        ...
        self.simple_stable_diffusion_generator.error = None
        self.mock_platform_sdk.send_photo.side_effect = Exception("Send photo error")
        ...
        # noinspection PyUnresolvedReferences
        self.mock_platform_sdk.send_photo.assert_called_once()

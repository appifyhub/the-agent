...
class DI:
    ...
    _telegram_progress_notifier: "TelegramProgressNotifier | None"
    _telegram_chat_bot: "TelegramChatBot | None"
    _command_processor: "CommandProcessor | None"
    _web_fetcher: "WebFetcher | None"
    _html_content_cleaner: "HTMLContentCleaner | None"
    _twitter_status_fetcher: "TwitterStatusFetcher | None"
    _exchange_rate_fetcher: "ExchangeRateFetcher | None"
    _ai_web_search: "AIWebSearch | None"
    _price_alert_manager: "PriceAlertManager | None"
    _generative_imaging_manager: "GenerativeImagingManager | None"
    _image_edit_manager: "ImageEditManager | None"
    _image_editor: "ImageEditor | None"
    _image_background_remover: "ImageBackgroundRemover | None"
    _image_contents_restorer: "ImageContentsRestorer | None"
    _computer_vision_analyzer: "ComputerVisionAnalyzer | None"
    _document_search: "DocumentSearch | None"
    _audio_transcriber: "AudioTranscriber | None"
    _attachments_content_resolver: "AttachmentsContentResolver | None"
    _announcement_manager: "AnnouncementManager | None"
    _information_announcer: "InformationAnnouncer | None"
    _release_summarizer: "ReleaseSummarizer | None"
    _user_support_manager: "UserSupportManager | None"
    ...
    def __init__(
        ...
        self._telegram_progress_notifier = None
        self._telegram_chat_bot = None
        self._command_processor = None
        self._web_fetcher = None
        self._html_content_cleaner = None
        self._twitter_status_fetcher = None
        self._exchange_rate_fetcher = None
        self._ai_web_search = None
        self._price_alert_manager = None
        self._generative_imaging_manager = None
        self._image_edit_manager = None
        self._image_editor = None
        self._image_background_remover = None
        self._image_contents_restorer = None
        self._computer_vision_analyzer = None
        self._document_search = None
        self._audio_transcriber = None
        self._attachments_content_resolver = None
        self._announcement_manager = None
        self._information_announcer = None
        self._release_summarizer = None
        self._user_support_manager = None
    ...
    def telegram_progress_notifier(
        ...
        if self._telegram_progress_notifier is None:
            from features.chat.telegram.telegram_progress_notifier import TelegramProgressNotifier
            self._telegram_progress_notifier = TelegramProgressNotifier(
                self.invoker_chat,
                message_id,
                self.telegram_bot_sdk,
                auto_start,
        ...
        return self._telegram_progress_notifier
    ...
    def telegram_chat_bot(
        ...
        if self._telegram_chat_bot is None:
            from features.chat.telegram.telegram_chat_bot import TelegramChatBot
            self._telegram_chat_bot = TelegramChatBot(
                self.invoker_chat,
                self.invoker,
                messages,
                attachment_ids,
        ...
        return self._telegram_chat_bot
    ...
    def html_content_cleaner(self, raw_html: str) -> "HTMLContentCleaner":
        if self._html_content_cleaner is None:
            from features.web_browsing.html_content_cleaner import HTMLContentCleaner
            self._html_content_cleaner = HTMLContentCleaner(raw_html, self.tools_cache_crud)
        return self._html_content_cleaner

    def twitter_status_fetcher(self, tweet_id: str) -> "TwitterStatusFetcher":
        if self._twitter_status_fetcher is None:
            from features.web_browsing.twitter_status_fetcher import TwitterStatusFetcher
            self._twitter_status_fetcher = TwitterStatusFetcher(
                tweet_id,
                self.invoker,
                self.tools_cache_crud,
                self.user_crud,
        ...
        return self._twitter_status_fetcher
    ...
    def ai_web_search(self, search_query: str, configured_tool: ConfiguredTool) -> "AIWebSearch":
        if self._ai_web_search is None:
            from features.web_browsing.ai_web_search import AIWebSearch
            self._ai_web_search = AIWebSearch(search_query, configured_tool)
        return self._ai_web_search
    ...
    def generative_imaging_manager(self, raw_prompt: str) -> "GenerativeImagingManager":
        if self._generative_imaging_manager is None:
            from features.chat.generative_imaging_manager import GenerativeImagingManager
            self._generative_imaging_manager = GenerativeImagingManager(
        ...
        return self._generative_imaging_manager
    ...
    def image_edit_manager(
        ...
        if self._image_edit_manager is None:
            from features.chat.image_edit_manager import ImageEditManager
            self._image_edit_manager = ImageEditManager(
                self.invoker_chat_id,
                attachment_ids,
                self.invoker_id,
                operation_name,
    ...
    def image_editor(
        ...
        if self._image_editor is None:
            from features.images.image_editor import ImageEditor
            self._image_editor = ImageEditor(image_url, replicate_api_key, context, mime_type)
    ...
    def image_background_remover(
        ...
        if self._image_background_remover is None:
            from features.images.image_background_remover import ImageBackgroundRemover
            self._image_background_remover = ImageBackgroundRemover(image_url, replicate_api_key, mime_type)
        return self._image_background_remover
    ...
    def image_contents_restorer(
        ...
        if self._image_contents_restorer is None:
            from features.images.image_contents_restorer import ImageContentsRestorer
            self._image_contents_restorer = ImageContentsRestorer(
                image_url,
                replicate_api_key,
                prompt_positive,
                prompt_negative,
        ...
        return self._image_contents_restorer
    ...
    def computer_vision_analyzer(
        ...
        if self._computer_vision_analyzer is None:
            from features.images.computer_vision_analyzer import ComputerVisionAnalyzer
            self._computer_vision_analyzer = ComputerVisionAnalyzer(
                job_id,
                image_mime_type,
                open_ai_api_key,
                image_url,
        ...
        return self._computer_vision_analyzer
    ...
    def document_search(
        ...
        if self._document_search is None:
            from features.documents.document_search import DocumentSearch
            self._document_search = DocumentSearch(job_id, document_url, open_ai_api_key, anthropic_token, additional_context)
    ...
    def attachments_content_resolver(
        ...
        if self._attachments_content_resolver is None:
            from features.chat.attachments_content_resolver import AttachmentsContentResolver
            self._attachments_content_resolver = AttachmentsContentResolver(
                self.invoker_chat_id,
                self.invoker_id,
                additional_context,
                attachment_ids,
        ...
        return self._attachments_content_resolver

    def announcement_manager(self, raw_message: str, target_telegram_username: str | None) -> "AnnouncementManager":
        if self._announcement_manager is None:
            from features.chat.announcement_manager import AnnouncementManager
        ...
        return self._announcement_manager

    def information_announcer(self, raw_information: str, target_chat: str | ChatConfig) -> "InformationAnnouncer":
        if self._information_announcer is None:
            from features.announcements.information_announcer import InformationAnnouncer
            self._information_announcer = InformationAnnouncer(
                raw_information,
                self.invoker_id,
                target_chat,
                self.user_crud,
        ...
        return self._information_announcer

    def release_summarizer(self, raw_notes: str, target_chat: str | ChatConfig | None = None) -> "ReleaseSummarizer":
        if self._release_summarizer is None:
            from features.announcements.release_summarizer import ReleaseSummarizer
            self._release_summarizer = ReleaseSummarizer(
                raw_notes,
                self.invoker_id,
                target_chat,
                self.user_crud,
        ...
        return self._release_summarizer
    ...
    def user_support_manager(
        ...
        if self._user_support_manager is None:
            from features.support.user_support_manager import UserSupportManager
            self._user_support_manager = UserSupportManager(
                user_input,
                self.invoker_id,
        ...
        return self._user_support_manager
